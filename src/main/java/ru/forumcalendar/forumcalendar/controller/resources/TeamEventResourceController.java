...
public class TeamEventResourceController {
    ...
    private static final String ROOT_MAPPING = "/editor/team_event?teamId=";
    ...
    public String add(
        ...
        return "redirect:" + ROOT_MAPPING + teamEventForm.getTeamId();
    }
    ...
    public String delete(
        ...
        return "redirect:" + ROOT_MAPPING + teamEvent.getTeam().getId();
    }
}
